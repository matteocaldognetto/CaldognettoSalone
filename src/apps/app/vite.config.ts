...
// Optional env vars for production only
const optionalEnvVars = ["GOOGLE_CLOUD_PROJECT", "GA_MEASUREMENT_ID"];
...
export default defineProject(({ mode }) => {
  ...
  // Optional env vars (set empty string if missing)
